...
public class TextOutsideCircleButton extends MenuButton {
    ...
    public static class Builder extends MenuButtonWithTextBuilder<Builder> {
        ...
        /**
         * The radius of popUp-button, in pixel.
         *
         ...
         * This method is used to calculate the position of popUp-button on the screen,
