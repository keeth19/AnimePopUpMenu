...
public class HamButton extends MenuButton {
    ...
    public static class Builder extends MenuButtonWithTextBuilder<Builder> {
        ...
        /**
         * Set the sub-text when popUp-button is at normal-state.
         * <br><br>
        ...
        /**
         * Set the sub-text resource when popUp-button is at normal-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the sub-text when popUp-button is at highlighted-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the sub-text resource when popUp-button is at highlighted-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the sub-text when popUp-button is at unable-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the sub-text resource when popUp-button is at unable-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the color of sub-text when popUp-button is at normal-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the color of sub-text when popUp-button is at highlighted-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
        ...
        /**
         * Set the color of sub-text when popUp-button is at unable-state.
         * <br><br>
         * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
         * then synchronize this change to popUp-button.
         *
         ...
         * By this method, you can set the position and size of the sub-text-view in popUp-button.
        ...
        /**
         * Set the width of popUp-button, in pixel.
         *
        ...
        /**
         * Set the height of popUp-button, in pixel.
         *
        ...
        /**
         * Get the height of popUp-button
         *
