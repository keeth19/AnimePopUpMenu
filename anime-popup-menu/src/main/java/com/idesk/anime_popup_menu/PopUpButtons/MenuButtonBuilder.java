...
public abstract class MenuButtonBuilder<T> {

    private MenuPiece piece = null;
    private WeakReference<MenuButton> popUpButtonWeakReference;

    // Basic
    int index = -1;
    InnerOnMenuButtonClickListener listener;
    ...
    public abstract MenuButton build(Context context);
    ...
    public MenuButton button() {
        if (popUpButtonWeakReference != null) return popUpButtonWeakReference.get();
        return null;
    }

    MenuButton weakReferenceButton(MenuButton button) {
        popUpButtonWeakReference = new WeakReference<>(button);
        return button;
    }
     ...
     */
    public void piece(MenuPiece piece) {
        this.piece = piece;
    }

    /**
     * Set the index of the popUp-button, only used in BMB package.
     *
     * @param index the index
     * @return the builder
     */
    public MenuButtonBuilder index(int index) {
        this.index = index;
        return this;
    }

    /**
     * Set the listener of the popUp-button, only used in BMB package.
     *
     * @param listener the listener
     * @return the builder
     */
    public MenuButtonBuilder innerListener(InnerOnMenuButtonClickListener listener) {
        this.listener = listener;
        return this;
    }

    /**
     * Set listener for when the popUp-button is clicked.
     *
    ...
    /**
     * Whether the popUp-button should have a shadow effect.
     *
    ...
    /**
     * Set the horizontal shadow-offset of the popUp-button.
     *
    ...
    /**
     * Set the vertical shadow-offset of the popUp-button.
     *
    ...
    /**
     * Set the radius of shadow of the popUp-button.
     *
    ...
    /**
     * Set the color of the shadow of popUp-button.
     *
    ...
    /**
     * Set the image drawable when popUp-button is at normal-state.
     * <br><br>
    ...
    /**
     * Set the image resource when popUp-button is at normal-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * Set the image drawable when popUp-button is at highlighted-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * Set the image resource when popUp-button is at highlighted-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * Set the image drawable when popUp-button is at unable-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * Set the image resource when popUp-button is at unable-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
     ...
     * By this method, you can set the position and size of the image-view in popUp-button.
    ...
    /**
     * Whether the popUp-button should have a ripple effect.
     *
    ...
    /**
     * The color of popUp-button when it is at normal-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The resource of color of popUp-button when it is at normal-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The color of popUp-button when it is at highlighted-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The resource of color of popUp-button when it is at highlighted-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The color of popUp-button when it is at unable-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The resource of color of popUp-button when it is at unable-state.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The color of popUp-button when it is just a piece.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * The resource of color of popUp-button when it is just a piece.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
    ...
    /**
     * Whether the popUp-button is unable, default value is false.
     * <br><br>
     * <STRONG>Synchronicity:</STRONG> If the popUp-button existed,
     * then synchronize this change to popUp-button.
     *
