...
import com.idesk.anime_popup_menu.BMBShadow;
...
public abstract class MenuButton extends FrameLayout {
    ...
    protected InnerOnMenuButtonClickListener listener;
    ...
    protected MenuButton(Context context) {
        super(context);
    }

    protected void initAttrs(MenuButtonBuilder builder) {
        index = builder.index;
    ...
    protected void initCircleButton() {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (!touchable) return;
                if (listener != null) listener.onButtonClick(index, MenuButton.this);
                if (onBMClickListener != null) onBMClickListener.onPopUpButtonClick(index);
            }
        });
    ...
    /**
     * Get the layout view of a popUp button.
     *
     * @return layout view
     */
    ...
    /**
     * Get the button layout view of a popUp button.
     *
    ...
    /**
     * Get the shadow view of a popUp button.
     *
     * @return shadow view
     */
    ...
    /**
     * Get the image view of a popUp button.
     *
     * @return image view
     */
    ...
    /**
     * Get the text view of a popUp button.
     *
     * @return text view
     */
    ...
    /**
     * Get the sub text view of a popUp button.
     *
