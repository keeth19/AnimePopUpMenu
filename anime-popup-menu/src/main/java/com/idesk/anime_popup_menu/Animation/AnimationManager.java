...
import static com.idesk.anime_popup_menu.Animation.MenuEnum.LINE;
...
public class AnimationManager {
    ...
    public static void rotate(MenuButton menuButton, long delay, long duration,
                              TimeInterpolator interpolator, float... degrees) {
        menuButton.setRotateAnchorPoints();
        for (int i = 0; i < menuButton.rotateViews().size(); i++) {
            View view = menuButton.rotateViews().get(i);
    ...
    public static void calculateShowXY(MenuEnum menuEnum, PointF parentSize, Ease ease, int frames,
                                       PointF startPosition, PointF endPosition, float[] xs,
                                       float[] ys) {
        if (Math.abs(startPosition.x - endPosition.x) < 1) menuEnum = LINE;
        ...
        switch (menuEnum) {
            ...
            case HORIZONTAL_THROW_2:
                ...
                break;
            case RANDOM:
                calculateShowXY(MenuEnum.values()[new Random().nextInt(MenuEnum.RANDOM.getValue())],
    ...
    public static void calculateHideXY(MenuEnum menuEnum, PointF parentSize, Ease ease, int frames,
                                       PointF startPosition, PointF endPosition, float[] xs,
                                       float[] ys) {
        if (Math.abs(startPosition.x - endPosition.x) < 1) menuEnum = LINE;
        ...
        switch (menuEnum) {
            ...
            case RANDOM:
            case Unknown:
                calculateShowXY(menuEnum, parentSize, ease, frames, startPosition, endPosition, xs,
                        ys);
                break;
            case HORIZONTAL_THROW_1:
                x2 = startPosition.x;
