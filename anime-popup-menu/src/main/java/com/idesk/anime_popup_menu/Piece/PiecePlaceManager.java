...
public class PiecePlaceManager {
    ...
    public static ArrayList<RectF> getDotPositions(PoupupMenuButton bmb, Point parentSize) {
    ...
    public static ArrayList<RectF> getHamPositions(PoupupMenuButton bmb, Point parentSize) {
    ...
    public static ArrayList<RectF> getShareDotPositions(PoupupMenuButton bmb,
                                                        Point parentSize,
                                                        int n) {
        ArrayList<RectF> positions = new ArrayList<>();
    ...
    public static MenuPiece createPiece(PoupupMenuButton bmb, MenuButtonBuilder builder) {
    ...
    private static Dot createDot(Context context, MenuButtonBuilder builder, float pieceCornerRadius) {
    ...
    private static Ham createHam(Context context, MenuButtonBuilder builder, float pieceCornerRadius) {
