...
public class CustomPositionActivity extends AppCompatActivity {
    ...
    private void initializeBmb1() {
        PoupupMenuButton bmb = findViewById(R.id.bmb1);
    ...
    private void initializeBmb2() {
        PoupupMenuButton bmb = findViewById(R.id.bmb2);
    ...
    private void initializeBmb3() {
        PoupupMenuButton bmb = findViewById(R.id.bmb3);
        for (int i = 0; i < 12; i++)
    ...
    private void initializeBmb4() {
        PoupupMenuButton bmb = findViewById(R.id.bmb4);
        for (int i = 0; i < 3; i++)
